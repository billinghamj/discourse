...
RSpec.describe Service::StepsInspector do
  class DummyService
    ...
    handle_exceptions { step :might_raise }
    step :final_step
  end
  ...
  describe "#inspect" do
    ...
    context "when service runs without error" do
      it "outputs all the steps of the service" do
        ...
        [ 8/10] [handle_exceptions] 'default' ✅
    ...
    context "when a step raises an exception inside the 'handle_exceptions' block" do
      before do
        class DummyService
          def might_raise
            raise "BOOM"
  ...
  describe "#error" do
    ...
    context "when an exception occurred inside the 'handle_exceptions' block" do
      before do
        class DummyService
          def might_raise
            raise "BOOM"
